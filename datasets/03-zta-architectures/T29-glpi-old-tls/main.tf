# T29 (GLPI via IaC): Protocolos Inseguros Ativos. 
# Configuração permitindo TLS 1.1 ou 1.0 no servidor web. 
# Intenção: Forçar o uso de TLS 1.2 ou superior e restrição de cifras (ciphers) fracas.
